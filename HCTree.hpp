...
class HCTree {
    ...
    public:
        ...
        ~HCTree();
        // void helperDeconstruct();

        void serialize(HCNode* current, FancyOutputStream & out);
        HCNode* deserialize(int &index, int len, FancyInputStream & in);
        /**
         ...
         */
        void build(const vector<int>& freqs, FancyOutputStream & out);
